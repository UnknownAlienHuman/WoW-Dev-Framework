...
pub enum RecognizerErrorCode {
    ...
    FactDuplicate,
    FactContextMismatch,
    FactPartitionUnknown,
    FactCoverageInvalid,
    FactBundleInvalid,
    FactBundleIdentityMismatch,
    FactBudgetExceeded,
    MatcherInputMismatch,
    MatchInvalid,
    MatchIdentityMismatch,
    MatchBudgetExceeded,
    ProposalInvalid,
    ProposalIdentityMismatch,
    ProposalBudgetExceeded,
    OutputPartitionInvalid,
    OutputPartitionIdentityMismatch,
    GraphHandoffIncomplete,
    GraphHandoffMismatch,
    GraphHandoffValueUnsupported,
    GraphHandoffInvalid,
